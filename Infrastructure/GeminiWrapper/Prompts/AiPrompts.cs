...
namespace Infrastructure.GeminiWrapper.Prompts
{
    public static class AiPrompts
    {
        ...
        public static string TranslateNews(string text)
        {
            ...
            13. اگر برای کلمه ای معنای فارسی درستی و واضحی وجود ندارد یا معادل فارسی آن رایج نیست حتما حتما همان کلمه ی انگلیسی رو به فلرسی بنویس، به عنوان مثلا: easter egg: ایستراگ. آن استفاده کن. در سربرگ خبر اصلا از کلمات انگلیسی استفده نشود و تنها کلمات فارسی و فینگلیش مجاز است.
